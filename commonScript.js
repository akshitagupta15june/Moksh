...
( () =>
{
  ...
  let footerContent = `
 <div class="footerWrapper w-full  lg:px-0 sm:w-2/3">

              <!-- Row - 1  -->
              <div class="row-1 flex w-full  sm:justify-between flex-col">

                <div class="flex flex-col w-full  sm:flex-row items-center justify-between">
                <img src="../Images/moksh.png" alt="Moksh Logo"  style="height: 80px; width: auto; background-color: white; display: block; margin-left: auto; margin-right: auto; border-radius:50px;">

                  
                  <div class="flex flex-col px-4 text-white items-center sm:px-0 w-full sm:w-2/3" style>
                  <span
                        class="text-center italic font-bold text-indigo-600 mb-1 sm:border-double sm:border-b-4 sm:border-indigo-600" style="display: block; margin-left: auto; margin-right: auto;">
                    A Spiritual Productivity Tool for Mental Wellness
                  </span>

                  <div class=" mt-1 px-5 w-full font-semibold flex items-center justify-center flex-col">
                    ...
                    <!-- Footer Socials  -->
                    <div
                         class="socials mt-4 row-2 w-full  flex  text-center capitalize font-semibold text-md hover:grey sm:text-[11px] >
                      ...
                      <a href="#" class=" text-decoration-none text-white ">Github</a>
                    </div>
                  </div>
