...
function genQuote() {
  ...
  var tweetQuote = quotes[randNum].replace(/<br>/g, "").split(" ").join("%20");
  console.log(tweetQuote);
  tweetQuote =
    "https://twitter.com/intent/tweet?text=" + encodeURIComponent(tweetQuote);
  document
